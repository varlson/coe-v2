  ...
  scholarship: {
    ...
    types: [
      ...
      },
      {
        ...
        instruc:
          "Contate-se com um professor, o qual deverá submeter um projeto nas datas indicadas pelo Edital. Mais informações... Pró-Reitoria de Extensão",
  ...
  contacts: [
    {
      ...
      presential: {
        mail: "Terça a quinta-feira, das 13h às 17h",
        tel: " coee@ufop.edu.br",
